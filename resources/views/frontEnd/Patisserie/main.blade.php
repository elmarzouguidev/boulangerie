                                ...
                                <div class="tab">
                                    <div id="filters-search" class="tab-content  first-tab ">
                                        ...
                                        <div class="listsearch-input-item location autocomplete-container">
                                            ...
                                            <input type="text" placeholder="location ?" class="autocomplete-input" id="autocompleteid3" value=""/>
                                            <a href="#"><i class="fal fa-location"></i></a>
                                        </div>
                                        <!-- listsearch-input-item end-->                                                       
                                        <!-- listsearch-input-item-->
                                        <div class="listsearch-input-item">
                                            {{-- <button class="toggle-filter-btn tsb_act "><i class="fal fa-clock"></i> <span>Ouvrir</span></button> --}}
                                        </div>
                                        <!-- listsearch-input-item end-->  
                                        <!-- listsearch-input-item-->
                ...
                <div class="col-md-8">
                    ...
                    <div class="list-main-wrap-header fl-wrap block_box no-vis-shadow">
                        ...
                        <div class="list-main-wrap-title">
                            <h2>Les boulangeries : <span> </span></h2>
                        </div>
                        ...
                        <div class="listing-item">
                            <article class="geodir-category-listing fl-wrap">
                                <div class="geodir-category-img">
                                    ...
                                    <img src="frontEnd/images/all/bakery1.jpg" alt=""> 
                                    </a>
                                    <div class="listing-avatar"><a href="author-single.html"><img src="frontEnd/images/avatar/1.jpg" alt=""></a>
                                        {{-- <span class="avatar-tooltip">Added By  <strong>Alisa Noory</strong></span> --}}
                                    </div>
                                    <div class="geodir_status_date gsd_open"><i class="fal fa-lock-open"></i>Ouvrir</div>
                                ...
                                <div class="geodir-category-content fl-wrap title-sin_item">
                                    <div class="geodir-category-content-title fl-wrap">
                                        <div class="geodir-category-content-title-item">
                                            <h3 class="title-sin_map"><a href="{{route('boulangerie.single','amoud')}}">Amoud</a><span class="verified-badge"><i class="fal fa-check"></i></span></h3>
                                            <div class="geodir-category-location fl-wrap"><a href="#" ><i class="fas fa-map-marker-alt"></i> Casablanca Maarif 125</a></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="geodir-category-footer fl-wrap">
                                        ...
                                        <div class="geodir-category_contacts">
                                            ...
                                            <ul class="no-list-style">
                                                <li><span><i class="fal fa-phone"></i> Appel : </span><a href="#">+2125666221452</a></li>
                                                <li><span><i class="fal fa-envelope"></i> Message : </span><a href="#">amoud@gmail.com</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>

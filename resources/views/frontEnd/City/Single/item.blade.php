    ...
    <article class="geodir-category-listing fl-wrap">
        <div class="geodir-category-img">
            ...
            <a href="" class="geodir-category-img-wrap fl-wrap">
              <img src="{{asset('frontEnd/images/all/bakery1.jpg')}}" alt=""> 
            </a>
        ...
        <div class="geodir-category-content fl-wrap">
            <div class="geodir-category-content-title fl-wrap">
                <div class="geodir-category-content-title-item">
                    <h3 class="title-sin_map"><a href="">Amoud</a><span class="verified-badge"><i class="fal fa-check"></i></span></h3>
                    <div class="geodir-category-location fl-wrap"><a href="#1" class="map-item"><i class="fas fa-map-marker-alt"></i> 27th Maarif Casablanca, MAROC</a></div>
                </div>
            </div>
            <div class="geodir-category-text fl-wrap">
                <p class="small-text">
                    Sed interdum metus at nisi tempor laoreet. Integer
                     gravida orci a justo sodales.
                    </p>
            ...
            <div class="geodir-category-footer fl-wrap">
                ...
                <div class="geodir-opt-list">
                    <ul class="no-list-style">
                        ...
                        <li>
                            ...
                            data-dynamicPath="[
                                {'src': '{{asset('frontEnd/images/all/1.jpg')}}'},
                                {'src': '{{asset('frontEnd/images/all/1.jpg')}}'}, 
                                {'src': '{{asset('frontEnd/images/all/1.jpg')}}'}
                            ]">
                ...
                <div class="geodir-category_contacts">
                    ...
                    <ul class="no-list-style">
                        <li><span><i class="fal fa-phone"></i> Appel : </span><a href="#">+212051234567896</a></li>
